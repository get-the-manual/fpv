...
- При подключении модуля DJI O4 может быть конфликт по портам UART и SBUS. Подробности в видео [Почему нет связи с приемником? Типовая проблема при использовании DJI O3/O4. YouTube: ZhukoRama FPVlog (ZRFPV)](https://www.youtube.com/watch?v=EpKfIepqhy0)
