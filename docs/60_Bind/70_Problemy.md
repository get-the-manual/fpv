...
Рекомендую начать с подробного ролика, описывающего множество причин:  
27 проблем ELRS: полный разбор [ELRS без боли: от пайки до прошивки. YouTube: DRONOFLY FPV](https://www.youtube.com/watch?v=j-pr-uSa6K8)
...
- При подключении модуля DJI O3/O4 может быть конфликт по портам UART и SBUS. Подробности в видео [Почему нет связи с приемником? Типовая проблема при использовании DJI O3/O4. YouTube: ZhukoRama FPVlog (ZRFPV)](https://www.youtube.com/watch?v=EpKfIepqhy0)
...
Так же нельзя использовать D250 и D500. Это устаревшие форматы.  
