...
Вот [статья с примером создания такого кабеля](10_VTX_Camera_Checking.md).
...
## Вопрос: я вижу в очках помехи или рябь. Это нормально?
1. Если рябь проявляется сильнее когда даешь газу и отсутствует когда дрон задизармлен - это помехи по питанию.  
Лечится подпайкой правильного конденсатора на питание. На 1S вупах обычно не заморачиваются и летают с этим.

2. На частоте, на которой летаешь есть другие устройства, например Wi-Fi роутер.  
Лечится экспериментальным выбором других частот. Чаще всего используются каналы R1 и R8.

3. Переотражение сигнала от стен и железяк. Частично лечится установкой антенны с круговой поляризацией на шлем и дрон. Переотраженный сигнал получается в другой поляризации и фильтруется антеной в очках/шлеме. По наблюдением, помех становится меньше даже если поставить такую антенну только на очки/шлем.
