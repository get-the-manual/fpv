...
## В каком порядке припаивать провода моторов
От порядка проводов зависит направление вращения.   
Можно паять в любом порядке.  
Потом в Betaflight на закладке Motors можно выставить нужное направление
