...
Насадить полетник на винты. Нос полетника там где цифры 1 и 2.  

Вставить камеру в канопу (шлейф должен быть СВЕРХУ) и прикрутить.    
...
Вставить шлейф от полетника в О4 модуль
