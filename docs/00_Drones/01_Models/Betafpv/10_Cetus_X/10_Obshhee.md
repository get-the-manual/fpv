...
1. Proshivka Betaflight НЕ УМЕЕТ работать с такими датчиками. Нет такой фичи. Говорят, она есть в прошивке INav, но это уже другая история.  
...
Proshivka оказалась очень убогая по своим возможностям по сравнению с Betaflight. И настраивается такой дрон не через Betaflight Configurator, а через [BETAFPV_Configurator](https://github.com/BETAFPV/BETAFPV_Configurator).  
