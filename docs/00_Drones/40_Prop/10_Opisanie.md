...
## Влияние шага пропеллера

[Why Pick High Or Low Pitched Props_ What's The Difference_ - FPV Questions - YouTube: 
Joshua Bardwell Livestream Clips](https://youtu.be/VcDjgViL0rc)

* **00:00–00:26** — Винты с **большим шагом (high-pitch)** создают больше тяги, но и большее аэродинамическое сопротивление. Из-за этого моторы медленнее изменяют обороты, а квадрокоптер становится менее отзывчивым. Низкий шаг обеспечивает более быструю реакцию на команды.

* **00:26–01:03** — Высокая отзывчивость моторов помогает PID-регулятору точнее стабилизировать квадрокоптер. Поэтому винты с меньшим шагом часто создают ощущение более качественной настройки PID.

* **00:26–01:03** — При высокой скорости винты с малым шагом достигают предела эффективности и перестают увеличивать тягу. Винты с большим шагом продолжают эффективно работать и позволяют развить более высокую максимальную скорость.

* **01:03–01:26** — Недостаток большого шага заключается в том, что такие винты хуже работают на малых скоростях и раньше входят в режим срыва потока. Поэтому зависание (hover) с ними менее эффективно.

* **01:03–01:26** — По мере роста скорости преимущество постепенно переходит к винтам с большим шагом: они становятся эффективнее и обеспечивают лучшую производительность на крейсерских и высоких скоростях.

* **01:26–01:50** — Если важны **плавность полёта, точное управление и зависание**, лучше выбирать винты с **меньшим шагом**.

* **01:26–01:50** — Если задача — **максимальная скорость**, а полёт проходит преимущественно на **50–60% газа и выше**, предпочтительнее винты с **большим шагом**.

* **01:50** — Для рекордных скоростей пилоты экспериментируют с различными значениями шага винтов, подбирая оптимальный вариант под конкретный квадрокоптер, моторы и условия полёта.

Подход автора полностью соответствует общепринятой практике настройки FPV-квадрокоптеров: выбор шага винта всегда является компромиссом между отзывчивостью управления, эффективностью на малой скорости и максимальной скоростью полёта.
