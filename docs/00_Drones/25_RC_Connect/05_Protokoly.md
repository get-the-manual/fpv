...
### 1. Дальность и надежность  {: #elrs-vs-cross-1 }
...
### 2. Задержка (Latency)  {: #elrs-vs-cross-2 }
...
### 3. Цена и доступность  {: #elrs-vs-cross-3 }
...
### 4. Совместимость и экосистема  {: #elrs-vs-cross-4 }
...
### 5. Помехоустойчивость  {: #elrs-vs-cross-5 }
