...
**Внимание:** Для данной зарядки требуется докупить отдельный блок питания с выходным напряжением 9V-20V следующих вариантов подключения:     
 - блока питания от 12 вс выходом ХТ60. Вариант такого блока питания см. ниже.  
 - блока питания с выходом DC(5.5*2.1mm)  
 - блока питания  поддерживающего протокол Power Delivery (PD3.0) и выходом USB-C  
...
### BETAFPV HexaCharger 1S Charger
[На сайте производителя](https://betafpv.com/products/hexacharger-1s-charger)  


![](BETAFPV_HexaCharger.png)

**Внимание:**  
1. Для данной зарядки требуется докупить отдельный блок питания.  
Можно запитывать от блока питания для смартфона, подключенного к зарядке через USB Type-C разъем.  
2. В этой зарядке шаг регулировки тока зарядки: 0.5А.   Использование зарядки для аккумуляторов на 260-300 mаh может привести к их **более быстрой деградации**.
...
### ToolkitRC Q4AC 
Одновременная зарядка **четырех** 1-4S батарей с коннектором XT60.  
...
[На сайте производителя](https://www.toolkitrc.com/product/q6ac/)  
...
## Полезные материалы
[Відкалібруй зарядку ToolkitRC M6D і забудь про проблеми. YouTube: SK PRODUCTION (укр.)](https://www.youtube.com/watch?v=y31e4E2nce0)
