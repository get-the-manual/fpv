...
**ВНИМАНИЕ** При финальном вытаскивании платы из корпуса обращайте внимание на слайдер питания (белого цвета). В нее вставлен хвостик от выключателя на плати. При неосторожном движении хвостик ломается под корень и тогда придется либо менять его, либо включать/выключать шлем острым предметом.
...
Если отломанный толкатель остался внутри слайдера, его можно вытащить:  
 - раскалить на спичке иголку  
 - воткнуть ее в отломанный хвостик  
 - подождать пока иголка остынет  
 - вытащить хвостик, потянув за иголку

## Замена чипа управления питанием `CN3162`
Если подключить включенный шлем к зарядке, через примерно минуту выходит из строя чип управления питанием. Такое предостережение есть даже в инструкции, но кто ж ее читает :))  
...
Перепаять чип непросто.  
Его нельзя просто перепаять паяльником, так как снизу на чипе полигон.  
Так что нужен фен.
